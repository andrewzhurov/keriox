...
#[derive(Serialize, Debug, Clone, PartialEq, rkyv::Archive, rkyv::Serialize, rkyv::Deserialize)]
#[serde(transparent)]
#[rkyv(derive(Debug))]
...
#[serde(untagged)]
#[rkyv(derive(Debug))]
// Taken from https://github.com/rkyv/rkyv/blob/bd382fdae66e93880971bb029180a671beb9b4d6/rkyv/examples/json_like_schema.rs
// To allow rkyv archive on recursive type.
...
pub enum ThresholdClauseEl {
    ...
    WeightedClausedThreshold(ThresholdFraction, #[rkyv(omit_bounds)] ClausedThreshold),
}
